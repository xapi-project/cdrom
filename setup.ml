...
(* OASIS_START *)
(* DO NOT EDIT (digest: dc2a5c5339664a7cb3577dd59f677f63) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["various"];
          homepage = None;
          synopsis = "CDROM device misc bindings";
          description = None;
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Z\241\214\185\234D\170h\022\178[\161#\220\018\135";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
